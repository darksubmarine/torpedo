...
case "$1" in
    ...
    docker-compose -p $DS_MKDOCS_SERVICENAME -f mdocs/docker-compose-docs.yml up -d --build
    sleep 5
    ...
    docker-compose -p $DS_MKDOCS_SERVICENAME -f mdocs/docker-compose-docs.yml down --remove-orphans
    ;;
